...
class SearchBox extends Component {
  ...
  //anonymous function that takes an event
  changeWhere = (e) => {
    //pass 'where' and it will equal whatever e.target.value is
  ...
  render() {
    //4 out of 12 cols wide at the medium breakpoint otherwise it will be the entire width
    return (
      <div className="home-search-box col m4">
        <h1>Book unique places to stay and things to do.</h1>
        {/* materialize class form */}
